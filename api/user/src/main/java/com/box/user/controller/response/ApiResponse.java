package com.box.user.controller.response;
...
public record ApiResponse(boolean error, String errorText) {
    ...
    /**
     * Creates a successful response with the given body and a custom HTTP status.
     * @param body the body of the response, representing the payload
     * @return a {@link ResponseEntity} with the provided HTTP status and the given body wrapped in a {@link Body}
     * @param <T> the type of the response body
     */
    public static <T> ResponseEntity<Body<T>> created(T body) {
        return ResponseEntity
    ...
    /**
     * Creates a successful response without body and a 204 No Content status.
     * @return a {@link ResponseEntity} with an HTTP 204 No Content status and an empty body wrapped in a {@link Body}
     * @param <T> the type of the response body
     */
    public static <T> ResponseEntity<Body<T>> noContent() {
        return ResponseEntity
